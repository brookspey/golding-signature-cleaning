...
const areas = [
  ...
  },
  {
    ...
    description:
      "Affordable, reliable cleaning services for Lake Worth homeowners. We work around your schedule to keep your home fresh and comfortable.",
  },
  {
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {areas.map((area) => (
              ...
              >
                <h2 className="mb-1 text-lg font-bold text-navy">{area.city}, FL</h2>
